...
[BLE 연결 안정성 문제]({% post_url 2026-05-11-10-00-00-500000-ble-connection-stability-reconnect-error-handling %})는 unit test + Patrol 조합으로 레이어별로 검증하는 게 가장 신뢰도 높다. unit test로 재연결 로직을 검증하고, Patrol로 실기기에서 OS 권한까지 포함한 전체 흐름을 확인한다.
